...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <!-- Design : csm uniquement (+ admin en lecture si defini) -->
            <?php if (hasPermission(['csm', 'admin'])): ?>
            <li>
                <a href="<?php echo BASE_URL; ?>/admin/design.php" class="<?php echo $currentPage === 'design.php' ? 'active' : ''; ?>">
            ...
            <!-- Utilisateurs : admin/super-admin -->
            <?php if (hasPermission('admin')): ?>
            <li>
                <a href="<?php echo BASE_URL; ?>/admin/utilisateurs.php" class="<?php echo $currentPage === 'utilisateurs.php' ? 'active' : ''; ?>">
            ...
            <?php if (hasPermission('admin')): ?>
            <li>
                <a href="<?php echo BASE_URL; ?>/admin/audit.php" class="<?php echo $currentPage === 'audit.php' ? 'active' : ''; ?>">
            ...
            <!-- Preferences : tous -->
            <li>
                <a href="<?php echo BASE_URL; ?>/admin/preferences.php" class="<?php echo $currentPage === 'preferences.php' ? 'active' : ''; ?>">
